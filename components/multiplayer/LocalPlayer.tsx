...
// 4 very far-apart corners first, then extra outer slots
...
export default function LocalPlayer() {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      yaw.current -= (mouseX - 0.5) * 0.03;

      pitch.current += (mouseY - 0.5) * 0.01;
    ...
    >
      ...
      <group ref={meshGroupRef}>
        ...
        <Html position={[0, 2.2, 0]} center distanceFactor={10} occlude>
          <div className="pointer-events-none select-none relative top-8">
            <div
